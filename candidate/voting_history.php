...
$query = "
    SELECT e.election_name, e.election_date, c.candidate_role, vh.voter_hash, v.total_votes
            ...
            <tbody>
                <?php foreach ($voting_history as $history): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($history['total_votes']); ?></td>
                        <td><?php echo htmlspecialchars($history['voter_hash']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
